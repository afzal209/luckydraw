                                    ...
                                    <div class="row gx-12">
                                       ...
                                       <div class="col-3">
                                          ...
                                          <div class="mb-3">
                                             ...
                                             <input type="text" name="customer_mail" id="customer_mail" class="form-control" placeholder="Enter Invoice Number" value="<?php echo e($customer_edit->email ?? ''); ?>">
                                          </div>
                                          <!-- Form group end -->
                                       </div>
                                       <div class="col-sm-4 col-12">
                                          ...
                                          <div class="mb-3">
                                             ...
                                             <input type="text" name="customer_phone" id="customer_phone" class="form-control" placeholder="919845012345" value="<?php echo e($customer_edit->mobile ?? ''); ?>">
                                          </div>
                                          <!-- Form group end -->
                                       </div>
                                    </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmtwo2/public_html/BusinessPartner/resources/views/manage_customer/add_new_customer.blade.php ENDPATH**/ ?>