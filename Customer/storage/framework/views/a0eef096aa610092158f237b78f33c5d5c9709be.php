            ...
            <div class="row justify-content-lg-between justify-content-center">
               ...
               <div class="col-xl-6 col-lg-5 col-md-8 col-sm-10 d-xl-flex d-lg-flex d-block align-items-center">
                  <div class="part-right">
                     <div class="part-img">
                        <img src="<?php echo e(URL::asset('img/sign-in/sign-in-img.png')); ?>" alt="">
                     </div>
                     <div class="part-text">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crm2amicrosharp/public_html/Customer/resources/views/index.blade.php ENDPATH**/ ?>