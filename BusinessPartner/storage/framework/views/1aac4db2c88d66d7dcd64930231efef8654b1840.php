   ...
   <div class="col-sm-12">
      <div class="card">
         <div class="card-body">
                     ...
                     <div id="exist" style="display:none" class="row">
                        <div class="col-md-12" >
                           ...
                           <select class="form-select" id="validationCustom04" required>
                              ...
                              <option value="<?php echo e($customers->customer_id); ?>"><?php echo e($customers->first_name); ?>-<?php echo e($customers->customer_id); ?></option>
                     ...
                     <div id="new" class="row">
                        ...
                        <div class="col-md-4 ">
                           ...
                           <div class="mb-3">
                              ...
                              <input type="text" name="customer_phone" id="customer_phone" class="form-control" placeholder="Enter Phone number with Countrycode" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                           </div>
                           <!-- Form group end -->
                        </div>
                        <!--<div class="col-md-4 ">-->
                  ...
                  <div class="col-md-12" >
                     <div class="card mb-12">
                        ...
                        <div class="card-body">
                           ...
                           <div class="form-check form-check-inline">
                              <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="<?php echo e($customer_groups->id); ?>" onclick="get_customer_data($(this))">
                              <label class="form-check-label" for="inlineCheckbox1"><?php echo e($customer_groups->group_name); ?> <?php echo e($customer_groups->value_count); ?> Ticket Buyers</label>
                           </div>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <!-- Row ends -->
            <!-- Row starts -->
            <form method="POST" action="<?php echo e(route('sales.new_sale.create')); ?>">
               <?php echo csrf_field(); ?>
               <div class="row">
                  <div class="col-12">
                              ...
                              <tbody id="multi_tr">
                                 ...
                                 <tr>
                                    <td>
                                       ...
                                       <select class="form-select" name="selectProduct[]" id="selectProduct1" onchange="get_luckydraw_id($(this),1)" required>
                                          ...
                                          <option value="<?php echo e($luckydraws->id); ?>"><?php echo e($luckydraws->luckydraw_name); ?></option>
                                          <?php endif; ?>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                       </select>
                                       <!-- Form group end -->
                                    ...
                                    <td>
                                       ...
                                       <div class="input-group m-0">
                                          <input type="text" class="form-control discount" name="discount[]" id="discount1" value="<?php echo e($Business_Partner->discount_status == 1 ? $Business_Partner->default_discount : 0); ?>" <?php echo e($Business_Partner->discount_status == 1 ? '' : 'disabled'); ?>   onchange="getTotal(1)" required>
                                    ...
                                    <td>
                                       <!-- Form group start -->
                                       <div class="input-group m-0">
                                          <input type="text" class="form-control vat" name="vat[]" id="vat1" value="<?php echo e($Business_Partner->tax_status == 1 ? $Business_Partner->default_tax : 0); ?>" <?php echo e($Business_Partner->tax_status == 1 ? '' : 'disabled'); ?>  onchange="getTotal(1)" >
                                          <span class="input-group-text">%</span>
                                       </div>
                                       <!-- Form group end -->
                                    </td>
                                 ...
                                 <tr>
                                    <td colspan="5" style="color:red" id="wallet_amount">
                                       <div id="wallet_total_amount"><?php echo e($Business_Partner->wallet_amount); ?></div>
                                    </td>
                                    <td>
...
<script>
   $(document).ready(function() {
       ...
       // $.ajax({
       //         url: "<?php echo e(url('sales/new_sale/add_customer_id')); ?>",
       //         type: "POST",
       //         data: {
   ...
   function get_customer_data(val){
       ...
       if ($(val).is(':checked')) {
           ...
           $.ajax({
               url: "<?php echo e(url('sales/new_sale/get_customer_data')); ?>",
               type: "POST",
               data: {
                   "_token": "<?php echo e(csrf_token()); ?>",
                   "value": id
   ...
   function get_customer_id(val){
       ...
       $('#customer_id_data').hide()
        $('#customer_label').text('');
        $.ajax({
               url: "<?php echo e(url('sales/new_sale/get_customer_id')); ?>",
               type: "POST",
               data: {
                   "_token": "<?php echo e(csrf_token()); ?>",
                   "value" :  value,
   ...
   function get_luckydraw_id(val,no){
       ...
       $('#qty' + no).val('');
        $.ajax({
               url: "<?php echo e(url('sales/new_sale/get_luckydraw_id')); ?>",
               type: "POST",
               data: {
                   "_token": "<?php echo e(csrf_token()); ?>",
                   "value" :  value,
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmtwo2/public_html/BusinessPartner/resources/views/sales/new_sale.blade.php ENDPATH**/ ?>