...
<!-- inner-hero-section start -->
    <div class="inner-hero-section style--six">
      <div class="bg-shape"><img src="{{URL::asset('images/elements/inner-hero-shape-2.png') }}" alt="image"></div>
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <ul class="page-list">
                  ...
                  <div class="contact-info-wrapper">
                    <div class="d-flex flex-wrap justify-content-between w-100">
                      <div class="contact-info">
                        <div class="contact-info__icon"><img src="{{URL::asset('images/icon/contact/1.png') }}" alt="image"></div>
                        <div class="contact-info__content">
                          <p>Phone Number</p>
                          <span>+91 9972 64 65 66</span>
                        </div>
                      </div><!-- contact-info end -->
                      <div class="contact-info">
                        <div class="contact-info__icon"><img src="{{URL::asset('images/icon/contact/2.png') }}" alt="image"></div>
                        <div class="contact-info__content">
                          <p>Email</p>
                          <span>info@ubglottery.com</span>
                        </div>
                      </div><!-- contact-info end -->
                    </div>
                    <div class="contact-thumb"><img src="{{URL::asset('images/elements/contact.png') }}" alt="image"></div>
                  </div>
                </div>
              </div>
            </div>
