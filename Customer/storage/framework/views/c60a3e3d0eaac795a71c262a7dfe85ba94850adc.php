...
<html>
   <head>
      ...
      <title><?php echo $__env->yieldContent('title'); ?> | Paklotto</title>
      ...
      <link rel="icon" type="image/png" href="<?php echo e(URL::asset('img/favicon.png')); ?>" sizes="16x16">
      ...
      <link rel="stylesheet" href="<?php echo e(URL::asset('css/all.min.css' )); ?>">
      <!-- owl carousel css -->
      <link rel="stylesheet" href="<?php echo e(URL::asset('css/owl.carousel.min.css' )); ?>">
      <!-- main css -->
      <link rel="stylesheet" href="<?php echo e(URL::asset('css/style.css' )); ?>">
      <?php if(Request::is('profile')): ?>
      <link rel="stylesheet" href="<?php echo e(URL::asset('date-p/mc-calendar.min.css' )); ?>">
      <?php endif; ?>
   ...
   <body>
         ...
         <div class="container">
            <div class="row">
               <div class="col-xl-3 col-lg-3 d-xl-flex d-lg-flex d-block align-items-center">
                  <div class="row">
                     <div class="col-xl-12 col-lg-12 col-6 d-xl-block d-lg-block d-flex align-items-center">
                        <div class="logo">
                           <a href='index.html'>
                           <img src="<?php echo e(URL::asset('img/logo.png')); ?>" alt="">
                           </a>
                        </div>
                     </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                           <ul class="navbar-nav m-auto">
                              ...
                              <li class="nav-item dropdown">
                                 ...
                                 <!--<a class='nav-link' href='<?php echo e(route('luckydraw.luckydraw')); ?>'>Luckydraws</a>-->
                                 <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li>
                                        <a class="dropdown-item <?php echo e(request()->routeIs('luckydraw.luckydraw') ? 'active' : ''); ?>" 
                                           href="<?php echo e(route('luckydraw.luckydraw')); ?>">
                                            My Luckydraws
                                        </a>
                                    </li>
                                    
                                    <li>
                                        <a class="dropdown-item <?php echo e(request()->routeIs('my.prizes') ? 'active' : ''); ?>" 
                                           href="<?php echo e(route('my.prizes')); ?>">
                                            My Prizes
                                        </a>
                                    </li>
                                 </ul>
               ...
               <div class="col-xl-3 col-lg-3 d-xl-flex d-lg-flex d-none align-items-center justify-content-end">
                  <a class='btn-pok mid' href='<?php echo e(route('customers.profile')); ?>'>My Profile <i class="fa-solid fa-user"></i></a>
               </div>
               <?php endif; ?>
            </div>
         </div>
      ...
      <?php if(Request::is('luckydraw')): ?>
      <script src="<?php echo e(URL::asset('js/lotteries-initialization.js')); ?>"></script>
      <?php elseif(Request::is('profile')): ?>
       <script src="<?php echo e(URL::asset('js/lotteries-initialization.js')); ?>"></script>
        <!-- register js initialize -->
        <script src="<?php echo e(URL::asset('date-p/mc-calendar.min.js')); ?>"></script>
      ...
      <script>
         $(document).ready(function() {
              $('#cmn-bt1').on('click', function(e) {
                  ...
                  // $.ajax({
                  //     url: "<?php echo e(url('post-register')); ?>",
                  //     type: "POST",
                  //     data: {
               ...
               $('#cmn-bt').on('click', function(e) {
                  ...
                  $.ajax({
                      ...
                      success: function(data) {
                          ...
                          // ✅ Redirect user
                          window.location.href = "<?php echo e(url('/luckydraw')); ?>"; // update to your actual URL
                      },
                      error: function(xhr) {
                          if (xhr.status === 422) {
...
</html><?php /**PATH /home/crm2amicrosharp/public_html/Customer/resources/views/layout.blade.php ENDPATH**/ ?>