                            ...
                            <table class="table truncate align-middle">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center"><img src="https://crm2.microsharp.net/uploads/customer/profile_image/<?php echo e($Sales->profile_image); ?>" class="img-3x rounded-5 me-3" alt="<?php echo e($Sales->first_name); ?>"></div>
...
?>
                                                <?php if($prize_distribution != ''): ?>
                                                    ...
                                                    <br>
                                                    <img src="https://crm2.microsharp.net/uploads/luckydraw/prizetransactions/<?php echo e($tx_proof); ?>" class="img-3x rounded-5 me-3" alt="Customer Name">
                                                    <br>
                                                    <?php if($prize): ?>
                                                        <!-- Display prize info -->
                                                        <br>
                                                        ...
                                                        <br>
                                                        <img src="https://crm2.microsharp.net/uploads/luckydraw/prizes/<?php echo e($prize->image); ?>" alt="Prize" style="width: 90px;height: 90px;">
                                                    <?php endif; ?>
                                                    <br>
                                                <?php else: ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/crmtwo2/public_html/BusinessPartner/resources/views/sales/view_sale.blade.php ENDPATH**/ ?>