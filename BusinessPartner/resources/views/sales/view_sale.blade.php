                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        <tr>
                                            ...
                                            <td align="center"><br><img src="{{ asset($Sales->sale_image_path) }}" class="img-3x rounded-5 me-3" alt="{{ $Sales->luckydraw_name }}"><br>Ticket ID:{{ $Sales->ticket_id }} </td>
...
@endphp
                                            ...
                                            <td>
                                                ...
                                                @if($prize_distribution != '') <!-- Customer Won the Ticket to Enable the Button -->
                                                    <a href="https://wa.me/919972646566?text=Dear%20Mr.%20Rammohan%2C%0A%0AI%E2%80%99m%20pleased%20to%20inform%20you%20that%20you%E2%80%99ve%20won%20in%20today%E2%80%99s%20lucky%20draw%20*{{$Sales->luckydraw_name}}*%20conducted%20by%20*UBG%20Company*.%20Your%20winning%20ticket%20ID%20is%20%5B*{{ $Sales->ticket_id }}*%5D.%0A%0AOur%20team%20will%20get%20in%20touch%20with%20you%20shortly%20regarding%20the%20next%20steps.%20In%20the%20meantime%2C%20please%20check%20your%20email%20for%20the%20draw%20details%20and%20open%20your%20Android%20app%20to%20view%20the%20latest%20status.%0A%0AThank%20you%20for%20choosing%20Rajkireet%20Luckydraw%20Store.%20Keep%20buying%20tickets%20with%20us%20for%20more%20chances%20to%20win%20exciting%20prizes!%0A%0AWarm%20Regards%2C%0A*{{$busniess_partner->poc_first_name}}*%0A{{$busniess_partner->poc_email}}%2C%20{{$busniess_partner->poc_mobile}}%0A{{$busniess_partner->area_name}}%2C%20{{$busniess_partner->region_name}}%2C%20{{$busniess_partner->city_name}}%0A{{$busniess_partner->city_name}}%2C%20{{$busniess_partner->state_title}}%0A{{$busniess_partner->country_name}}%2C%20{{$busniess_partner->zip_code}}" target="_blank" class="btn btn-primary"><i class="bi bi-whatsapp"></i> Click To Inform Winner</a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
