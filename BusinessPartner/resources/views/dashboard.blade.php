...
@section('content')
                           ...
                           <div class="card-body">
                              <div class="d-flex align-items-center">
                                 ...
                                 <div class="d-flex flex-column">
                                    <h2 class="lh-1">{{$tickets}}</h2>
                                    <p class="m-0 opacity-50">Tickets Sold</p>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center justify-content-between mt-1">
                                 <a class="text-primary" href="{{route('sales.view_sale')}}">
                        ...
                        <div class="card mb-4">
                           <div class="card-body">
                              <div class="d-flex align-items-center">
                                 ...
                                 <div class="d-flex flex-column">
                                    <h2 class="lh-1">{{$luckydraw->value_count}}</h2>
                                    <p class="m-0 opacity-50">Luckydraws</p>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center justify-content-between mt-1">
                                 <a class="text-primary" href="{{route('product')}}">
                        ...
                        <div class="card mb-4">
                           <div class="card-body">
                              <div class="d-flex align-items-center">
                                 ...
                                 <div class="d-flex flex-column">
                                    <h2 class="lh-1">{{$customer}}</h2>
                                    <p class="m-0 opacity-50">Customers</p>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center justify-content-between mt-1">
                                 <a class="text-primary" href="{{route('manage_customer.view_customer')}}">
                        ...
                        <div class="card mb-4 bg-primary">
                           <div class="card-body text-white">
                              <div class="d-flex align-items-center">
                                 ...
                                 <div class="d-flex flex-column">
                                    <h2 class="m-0 lh-1">€ {{$wallet->wallet_amount}}/-</h2>
                                    <p class="m-0 opacity-50">My Wallet</p>
                                 </div>
                              </div>
                              <div class="d-flex align-items-center justify-content-between mt-1">
                                 <a class="text-white" href="{{route('wallet_transaction')}}">
                                 <span>View All Transactions</span>
                                 <i class="bi bi-arrow-right ms-2"></i>
                                 </a>
                                 <div class="text-end">
                                    <a href="{{route('wallet')}}" type="button" class="badge bg-danger text-white small">Load Amount</a>
                                 </div>
								<!-- Modal -->
                ...
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex flex-column p-3 border rounded-2">
                        <div class="d-flex align-items-center flex-row mb-3">
                            <img src="{{request()->getSchemeAndHttpHost()}}/uploads/customer/profile/{{$sales->profile_image}}" class="img-4x rounded-5 me-3" alt="{{$sales->first_name}}">
                            <p class="m-0">{{$sales->first_name}}<br>
                                <small>{{$sales->customer_id}}</small><br><small>{{$sales->mobile}}</small>
                            </p>
                        </div>
                         {{$sales->luckydraw_name}} {{$sales->ticket_id}} bought on {{$sales->created_at}}
                            <?php
    ...
    <button class="carousel-control-next" type="button" data-bs-target="#notificationCarousel" data-bs-slide="next">
        ...
        <span class="visually-hidden">Next</span>
                           ...
                           <a href="{{$url}}" target="_blank" class="btn btn-info btn-lg text-white">View All Winners in Website<i class="bi bi-web"></i></a>
                        </div>
                     </div>
                  </div>
